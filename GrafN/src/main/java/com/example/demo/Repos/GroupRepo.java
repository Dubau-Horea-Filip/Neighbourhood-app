...
//    Optional<Group> findById(@Param("groupId") Long groupId);
    ...
    //I had to remove it because  "The query used a deprecated function. ('id' is no longer supported)"
//    @Query("MATCH (g:Group {id: $groupId})\n" +
//            " MATCH (f:Friend {email: $friendEmail})\n" +
//            "WHERE NOT EXISTS((f)-[:GROUP]-(g)) " +
//            "CREATE (f)-[:GROUP]->(g)\n")
//    void addGroupDependency(@Param("groupId") Long groupId, @Param("friendEmail") String friendEmail);
